...
from scripts.act_manager.act_manager import add_act, clear_queue, get_acts, del_act, is_paused, play_new_act_by_act, play_new_act_by_name, push_to_queue_by_act, push_to_queue_by_name, stop, toggle_pause, stop_and_clear, get_acts_names
Actions = {
