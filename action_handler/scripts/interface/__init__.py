from scripts.interface.interface import set_current_route_name, get_current_route_name, change_view_set, get_set, get_sets, force_change_view_set, get_route
