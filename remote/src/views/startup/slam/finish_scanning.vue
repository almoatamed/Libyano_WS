        ...
        <v-container fluid>
            <v-row>
                ...
                >
                    ...
                    style="text-align: center;"
                    >
                     Go to the startup map and start moving the robot around untill you think it has a satisfying visualizaiton of its sorroundings. <br> Then, come back here and confirm that you finished scanning.
                    </div>
                </v-col>
