        ...
        <v-container fluid>
            <v-row>
                ...
                >
                    ...
                    >Build map by scanning the sorrounding area</div>
                </v-col>
                <v-col
                style="display: flex; justify-content: space-around"
                >
                    ...
                    style="text-align: center;"
                    >
                     In order to build a map you need to manually move the robot around the place till the robot having a good visual of its sourrounding where it will autonomously navigate
                    </div>
                </v-col>
                <v-col cols="12"  style="display: flex; justify-content: space-around">
                    ...
                    <v-card class="pa-4">
                        ...
                        <v-card-text>
                            you can start scanning the sorrounding area by navigating arount the robot manually
                            <br> Start Scanning?
                        </v-card-text>
                        ...
                        <v-btn
                            color="purple"
                            text
                            @click="start_scanning();start_scanning_dialog=false"
                        >
                            Yes
                        </v-btn>
                        <v-spacer></v-spacer>
                        <v-btn
                            color="purple"
                            text
                            @click="start_scanning_dialog = false"
                        >
                            Not Yet
                        </v-btn>
                        </v-card-actions>
