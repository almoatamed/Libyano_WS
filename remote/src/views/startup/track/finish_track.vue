        ...
        <v-container fluid>
            <v-row>
                ...
                >
                    ...
                    style="text-align: center;"
                    >
                     Go to the startup map and start moving the robot around using chain of goals, untill you think it has a satisfying visualizaiton of its sorroundings. <br> Then, come back here and confirm that you finished scanning
                    </div>
                </v-col>
                <v-col cols="12"  style="display: flex; justify-content: space-around">
                    ...
                    <v-dialog
                    v-model="finish_scanning_dialog"
                    :dark='isDark'
                    width="500"
                    >
                    <template v-slot:activator="{ on, attrs }">
                    ...
                    <v-card class="pa-4">
                        ...
                        <v-card-text>
                            Are you sure that the robot has a good visualization of the area now?
                        </v-card-text>
                        ...
                        <v-btn
                            color="purple"
                            text
                            @click="finish_scanning();finish_scanning_dialog=false"
                        >
                            Yes
                        </v-btn>
                        <v-spacer></v-spacer>
                        <v-btn
                            color="purple"
                            text
                            @click="finish_scanning_dialog = false"
                        >
                            Not Yet
                        </v-btn>
                        </v-card-actions>
