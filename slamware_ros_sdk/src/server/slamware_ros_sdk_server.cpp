...
namespace slamware_ros_sdk {
    ...
    bool SlamwareRosSdkServer::init_(std::string& /*errMsg*/)
    {
        ...
        // init all subscriptions
        {
            ...
            subSetHomePose_ = subscribe_T_<geometry_msgs::Pose>("set_home_pose", 1U, &SlamwareRosSdkServer::msgCbSetHomePose_);
    ...
    void SlamwareRosSdkServer::msgCbSetHomePose_(slamware_platform_t& pltfm, const geometry_msgs::Pose::ConstPtr& msg)
    {
        rpos::core::Pose robotPose;
        rosMsgToSltc(*msg, robotPose);

        pltfm.setHomePose(robotPose);
    }
