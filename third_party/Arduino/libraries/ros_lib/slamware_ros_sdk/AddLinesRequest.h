#ifndef _ROS_slamware_ros_sdk_AddLinesRequest_h
#define _ROS_slamware_ros_sdk_AddLinesRequest_h
...
namespace slamware_ros_sdk
{
  ...
  class AddLinesRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "slamware_ros_sdk/AddLinesRequest"; };
