#ifndef _ROS_slamware_ros_sdk_MoveLineRequest_h
#define _ROS_slamware_ros_sdk_MoveLineRequest_h
...
namespace slamware_ros_sdk
{
  ...
  class MoveLineRequest : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "slamware_ros_sdk/MoveLineRequest"; };
