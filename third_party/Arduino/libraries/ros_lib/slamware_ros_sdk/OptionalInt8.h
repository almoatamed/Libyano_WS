#ifndef _ROS_slamware_ros_sdk_OptionalInt8_h
#define _ROS_slamware_ros_sdk_OptionalInt8_h
...
namespace slamware_ros_sdk
{
  ...
  class OptionalInt8 : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "slamware_ros_sdk/OptionalInt8"; };
    const char * getMD5(){ return "0651b4f03fa9e5e40dfe4f2aef0d4eb1"; };
