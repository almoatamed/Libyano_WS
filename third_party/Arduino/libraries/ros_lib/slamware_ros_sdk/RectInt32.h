#ifndef _ROS_slamware_ros_sdk_RectInt32_h
#define _ROS_slamware_ros_sdk_RectInt32_h
...
namespace slamware_ros_sdk
{
  ...
  class RectInt32 : public ros::Msg
  {
    public:
    ...
    const char * getType(){ return "slamware_ros_sdk/RectInt32"; };
