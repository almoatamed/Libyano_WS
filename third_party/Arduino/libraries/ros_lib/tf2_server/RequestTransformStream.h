...
static const char REQUESTTRANSFORMSTREAM[] = "tf2_server/RequestTransformStream";
  ...
  class RequestTransformStreamRequest : public ros::Msg
  {
    ...
    RequestTransformStreamRequest():
      parent_frame(""),
      child_frames_length(0), child_frames(NULL),
    ...
    const char * getType(){ return REQUESTTRANSFORMSTREAM; };
    const char * getMD5(){ return "a7c59a6e27bac6bb75c581e511c7bdba"; };
  ...
  class RequestTransformStreamResponse : public ros::Msg
  {
    ...
    const char * getType(){ return REQUESTTRANSFORMSTREAM; };
    const char * getMD5(){ return "42ea15d06263d0e97103be7c351c819e"; };
